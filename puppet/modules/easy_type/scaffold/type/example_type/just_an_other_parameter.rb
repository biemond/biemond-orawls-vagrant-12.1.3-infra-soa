...
newparam(:just_an_other_parameter) do
  include EasyType
  #
  # newparam
  # ==========
  ...
  # to an Uppercase value before comparing it with the acual value.
  #
  # Validators
  # ==========
  ...
  desc 'Give your desciption of the parameter'
